...
public class AnimalRectangle extends Rectangle {
	...
	private LinkedList<AnimalLabel> animals = new LinkedList<AnimalLabel>(); // 우리 안의 동물들 목록
	...
	@Override
	public boolean contains(Point p) { // 오버라이드하여 재작성하는 것이 더 직관성있게 평가할 수 있었다(기존 함수는 안 먹힘)
		// TODO Auto-generated method stub
